...
public class PizzaControlador extends HttpServlet {
    ...
    // Adicionando a variável 'tamanho'
    String codPizza="", nome="", precoBase="", pizza_borda="", tamanho="";
    ...
    private void cadastrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        objPizza.setTamanho(tamanho); // Setando o tamanho no objeto
    ...
    private void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("tamanho", tamanho); // Enviando 'tamanho' para a view
    ...
    public void validaCampos() {
        ...
        if ((nome == null) || (nome.isEmpty()) || (precoBase == null) || (precoBase.isEmpty()) || 
            (pizza_borda == null) || (pizza_borda.isEmpty()) || (tamanho == null) || (tamanho.isEmpty())) {
    ...
    private void cancelar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("tamanho", ""); // Limpando o campo
