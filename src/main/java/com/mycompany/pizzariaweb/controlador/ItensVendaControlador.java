...
public class ItensVendaControlador extends HttpServlet {
    ...
    String pizzaVenda="", bebidaVenda="", codPedido="", quantidade="", valor="", codItensVenda="",
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            bebidaVenda = request.getParameter("bebidaVenda");
    ...
    private void vender(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if((pizzaVenda == null || pizzaVenda.isEmpty()) && (bebidaVenda == null || bebidaVenda.isEmpty()))
            throw new IllegalArgumentException("Um ou mais parâmetros estão ausentes");
        
        Pizza pizzaVendida = pizzaDao.buscarPorId(Integer.valueOf(pizzaVenda));
        Bebida bebidaVendida = bebidaDao.buscarPorId(Integer.valueOf(bebidaVenda));
        itensVenda.setQuantidade(Integer.valueOf(quantidade));
        itensVenda.setValor((pizzaVendida.getPrecoBase()+bebidaVendida.getPrecoBebida()) * Integer.valueOf(quantidade)); // Para calculo do valor total a pagar
        ...
        itensVenda.getObjItens_codBebida().setCodigoBebida(Integer.valueOf(bebidaVenda));
